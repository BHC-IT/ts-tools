...
describe('test String', function() {
	...
	it('toLocaleLowerCase', function() {
		const test = "\u0130";
		expect(String.toLocaleLowerCase(test, 'en-US') !== String.toLocaleLowerCase(test, 'tr')).to.eql(true);
	});

	it('toLocaleUpperCase', function() {
		const test = 'istanbul';

		expect(String.toLocaleUpperCase(test, 'en-US') !== String.toLocaleUpperCase(test, 'tr')).to.eql(true);
	});
