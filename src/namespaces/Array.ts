...
export namespace Array {
	...
	export const findIndex = <A>(arr: Array<A>, f: Predicate<A>) =>
		arr.findIndex(f)
	...
	export const pop = <A>([...arr]: Array<A>) =>
		ts.forward(arr.pop(), () => arr)
	export const push = <A>([...arr]: Array<A>, ...values: A[]) =>
		ts.forward(arr.push(...values), () => arr)
	...
	export const shift = <A>([...arr]: Array<A>) =>
		ts.forward(arr.shift(), () => arr)
	...
	export const unshift = <A>([...arr]: Array<A>, v: A, ...values: A[]) =>
		ts.forward(arr.unshift(v, ...values), () => arr)
