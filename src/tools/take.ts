...
*/
export type Take<T extends unknown[], Count extends number, Taken extends unknown[] = []> =
	Taken extends {length: infer U} ? U extends Count ? Taken : Take<Tail<T>, Count, [...Taken, Head<T>]> : never
...
/**
	...
	* @author Valentin Vivier <lanathlor>
*/
export const take = <A extends unknown[], Count extends number>(nb : Count, t : [...A]): Take<A, Count> => t.slice(0, nb) as Take<A, Count>;